...
class BbcSignInPage
    ...
    # REGISTER_LINK = 'https://account.bbc.com/register?context=homepage&nonce=Zu81iiBv-rViA3fJZHk7Rh2x8rJJDWzJrVww&ptrt=https%3A%2F%2Fwww.bbc.co.uk%2F&userOrigin=homepage'
    ...
    def click_register_link
        find(:xpath, '//*[@id="signin-page"]/div[2]/div[2]/div[2]/div[2]/a').click()
    end
